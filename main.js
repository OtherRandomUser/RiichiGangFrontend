						...
						case 'BadUrl':
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										error: $elm$core$Maybe$Just('Url inválida: ' + url)
									}),
								$elm$core$Platform$Cmd$none);
						case 'Timeout':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										error: $elm$core$Maybe$Just('Erro de timeout, tente novamente')
									}),
								$elm$core$Platform$Cmd$none);
						case 'NetworkError':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										error: $elm$core$Maybe$Just('Erro de rede, verifique a sua conexão e tente novamente')
									}),
								$elm$core$Platform$Cmd$none);
						case 'BadStatus':
							var body = error.b;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										error: $elm$core$Maybe$Just(body)
									}),
								$elm$core$Platform$Cmd$none);
						default:
							var body = error.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										error: $elm$core$Maybe$Just('Falha interna: ' + body)
									}),
								$elm$core$Platform$Cmd$none);
					}
				}
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('/perfil'),
