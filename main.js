						...
						return A3(
							...
							function (email) {
								return A3(
									...
									function (ownedClubs) {
										return $elm$json$Json$Decode$succeed(
											{createdAt: createdAt, email: email, id: id, ownedClubs: ownedClubs, username: username});
									});
							});
					});
			});
			...
			switch (_v0.a.$) {
				...
				case 'ConfirmEdit':
					if (_v0.b.$ === 'EditProfile') {
						...
						var user = _v6.a;
						var form = _v6.b;
						var _v7 = $author$project$Page$User$validatePatch(form);
						if (_v7.$ === 'Ok') {
							var _v8 = model.session;
							if (_v8.$ === 'LoggedIn') {
								var viewer = _v8.b;
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('TODO filiacoes')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('TODO torneios')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('TODO notificações')
					]))
			]),
		title: 'Login'
	};
